...
public class DualCardUtils {
    ...
    private static final int PRD_ID = 1540;
    ...
    public void autoGrandPermission() {
        ...
        while (deviceIterator.hasNext()) {
            ...
            if (device.getVendorId() == VEN_ID && device.getProductId() == PRD_ID) {
    ...
    public void getConnectedDevice() {
        ...
        devices = dualCardJni.DE_FindUsbDevice(activity.getApplicationContext());
        if (devices.isEmpty()) {
